...
function serve() {
    ...
    watch('src/img/*.svg', svgTask);
    watch('src/img/*.{png,jpg,jpeg}', imgTask);
...
module.exports = {
    serve: series(clean, parallel(htmlTask, cssTask, imgTask, svgTask, jsTask), serve),
    default: series(enableProd, clean, parallel(htmlTask, cssTask, imgTask, svgTask, jsTask))
};
